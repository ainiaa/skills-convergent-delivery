---
name: converge-eval
description: Evaluate Converge Suite behavior with frozen control/candidate comparisons, fresh multi-sample decisions, and regressions selected from touched control surfaces. Use after changing Converge rules, or before releasing Suite behavior changes via the deterministic preflight; do not use for implementation, review, or deployment.
metadata:
