...
metadata:
  compatibility: Requires the complete Converge core and explicit autonomy installation.
---
...
Installation and removal require the explicit installer options. A service is
separate from a hook and is only for the documented low-risk route.
